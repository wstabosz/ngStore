 ...
 *
 * <pre>
 *   shopCartAppDev = angular.module('shopCartAppDev', ['shopCartApp', 'ngMockE2E']);
 *   shopCartAppDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('shopCartApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('shopCartApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('shopCartApplicationModule'));
   *
   *
